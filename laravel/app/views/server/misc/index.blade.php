    ...
    <tbody>
        @foreach($miscs as $misc)
            <tr style = "font-size:11px;" id = "items">
                ...
                <td style = "width:13px;">{{ link_to_route('Miscellaneous.edit', 'Edit',
                     array($misc->m_id), array('class' => 'btn btn-info', 'id' => 'btnedit')) }}
                </td>
                 <td  style = "width:13px;">
                        {{ Form::open(array('method' 
                    => 'DELETE', 'route' => array('Miscellaneous.destroy', $misc->m_id))) }}                       
