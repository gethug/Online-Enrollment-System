...
<div class="container crud">
  ...
  <h2 class = "crud-head">Class Start</h2>
 	...
 	{{Form::open(array('route' => 'ClassStart.store', 'class' => 'form-inline'))}}
@if($errors->first('schoolyear')) 
  ...
  <strong>Warning!</strong> {{ $errors->first('schoolyear')}}
 	...
 	<div class = "div-text start" style = "width: 100%;">
 		{{Form::text('ClassStart', '', array('placeholder' => 'Start of Class', 'class' => 'form-control feilds', 'id' => 'datetimepicker', 'style' => 'width: 100%;cursor:pointer;', 'readonly'))}}
...
@if($errors->first('start')) 
	...
	<div class="form-group div-filds" style = "width: 100%;">
		...
		<div class = "div-text end" style = "width: 100%;">
 		{{Form::text('ClassEnd', '', array('placeholder' => 'End of Class', 'class' => 'form-control feilds', 'id' => 'datetimepicker1', 'style' => 'width: 100%;cursor: pointer;', 'readonly'))}}
