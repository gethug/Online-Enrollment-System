...
<div class="container crud">
  ...
  <h2 class = "crud-head">Edit Section</h2>
 	...
 	{{Form::open( array('route' => array('Adviser.update', $advisers->sec_id), 'class' => 'form-inline', 'method' => 'PUT'))}}

<script>
        $(document).ready(function() { $("#e1").val(["{{$advisers->sec_id}}"]).select2(); });
        $(document).ready(function() { $("#e2").val(["{{$advisers->t_id}}"]).select2(); });
