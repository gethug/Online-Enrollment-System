 	...
 	{{Form::open(array('route' => array('Enrolee.update', $enrolees->en_id), 'class' => 'form-inline', 'method' => 'PUT'))}}
 			...
 			<script type="text/javascript">
			    $(document).ready(function(){
			        $("#level option[value= {{$enrolees->lvl_id}}]").attr("selected", "selected");
			        $("#type option[value= {{$enrolees->type}}]").attr("selected", "selected");
				});
			</script>
...
<!-- div for levels //////////////////////////////////////////////////////////////////////////////////////////////////////////-->
 	<div class="form-group div-filds" style = "width:100%">
			<div class = "div-text" style = "width:100%">
	 			<select class="form-control feilds" style = "width:98%;" name = "type" id = "type" readonly>
...
<!-- div for mail address ////////////////////////////////////////////////////////////////////////////////////////////////////-->
	...
	<div class="form-group div-filds" style = "width:100%">
		...
		<div class = "div-text id" style = "width:100%">
 			{{Form::text('ID', $enrolees->en_id, array('placeholder' => 'Student ID', 'class' => 'form-control feilds', 'id' => 'filds', 'style' => 'width:98%;', 'readonly'))}}
 		</div>
...
<!-- div for name ////////////////////////////////////////////////////////////////////////////////////////////////////-->
 	...
 	<div class = "div-text fname">
 		{{Form::text('Firstname', $enrolees->fname, array('placeholder' => 'First name', 'class' => 'form-control feilds', 'id' => 'n-filds' , 'readonly'))}}
 		</div>
 		{{Form::text('Mname', $enrolees->mname, array('placeholder' => 'Middle name', 'class' => 'form-control feilds', 'id' => 'n-filds', 'readonly'))}}
 	<div class = "div-text lname">
 		{{Form::text('Lastname', $enrolees->lname, array('placeholder' => 'Last name', 'class' => 'form-control feilds', 'id' => 'n-filds', 'readonly'))}}
 		</div>
...
<!-- div for home address ////////////////////////////////////////////////////////////////////////////////////////////////////-->
 	...
 	<div class = "div-text hadd" style = "width: 100%;">
 		{{Form::text('HomeAddress', $enrolees->h_addres, array('placeholder' => 'Home Address', 'class' => 'form-control feilds', 'id' => 'n-filds', 'style' => 'width: 98%;', 'readonly'))}}
 		</div>
...
<!-- div for city address////////////////////////////////////////////////////////////////////////////////////////////////////-->
 	...
 	<div class = "div-text cadd" style = "width: 100%;">
 		{{Form::text('CityAddress', $enrolees->c_addres, array('placeholder' => 'City Address', 'class' => 'form-control feilds', 'id' => 'n-filds', 'style' => 'width: 98%;', 'readonly'))}}
 		</div>
...
<!-- div for birth place and birth date////////////////////////////////////////////////////////////////////////////////////////////////////-->
 	...
 	<div class = "div-text bplace" style = "width: 70%;">
 		{{Form::text('Birthplace', $enrolees->b_place, array('placeholder' => 'Place of Birth', 'class' => 'form-control feilds', 'id' => 'n-filds', 'style' => 'width: 100%;', 'readonly'))}}
 		</div>

 		<div class = "div-text bdate" style = "width: 28%;">
 		{{Form::text('datebirth', $enrolees->b_date, array('placeholder' => 'Date of Birth', 'class' => 'form-control feilds', 'id' => 'datetimepicker', 'style' => 'width: 100%;', 'readonly'))}}
 		</div>
 ...
 <!-- div for nationality and religion////////////////////////////////////////////////////////////////////////////////////////////////////-->
 	...
 	<div class = "div-text nat" style = "width: 48%;">
 		{{Form::text('Nationality', $enrolees->nationality, array('placeholder' => 'Nationality', 'class' => 'form-control feilds', 'id' => 'n-filds', 'style' => 'width: 100%;', 'readonly'))}}
 		</div>
 		
 	<div class = "div-text rel" style = "width: 50%;">
 		{{Form::text('Religion', $enrolees->religion, array('placeholder' => 'Religion', 'class' => 'form-control feilds', 'id' => 'n-filds', 'style' => 'width: 100%;', 'readonly'))}}
 		</div>
 ...
 <!-- div for prev school and SY////////////////////////////////////////////////////////////////////////////////////////////////////-->
 	...
 	<div class = "div-text pschool" style = "width: 65%;">
 		{{Form::text('PreviousSchool', $enrolees->prev_school, array('placeholder' => 'Previous School Attended', 'class' => 'form-control feilds', 'id' => 'n-filds', 'style' => 'width: 100%;', 'readonly'))}}
 		</div>

 	<div class = "div-text sy" style = "width: 33%;">
 		{{Form::text('Schoolyear', $enrolees->schoolyear, array('placeholder' => 'School Year', 'class' => 'form-control feilds', 'id' => 'n-filds', 'style' => 'width: 100%;', 'readonly'))}}
 		</div>
...
<!-- div for mail address ////////////////////////////////////////////////////////////////////////////////////////////////////-->
	...
	<div class="form-group div-filds" style = "width:100%">
		...
		<div class = "div-text mail" style = "width:100%">
 			{{Form::text('mailaddress', $enrolees->mail_add, array('placeholder' => 'Previous School Mailing Address', 'class' => 'form-control feilds', 'id' => 'filds', 'style' => 'width:98%;', 'readonly'))}}
 		</div>
...
<!-- div for name ////////////////////////////////////////////////////////////////////////////////////////////////////-->
 	...
 	<div class = "div-text pfname">
 		{{Form::text('ParentFirstname', $parents->f_name, array('placeholder' => 'First name', 'class' => 'form-control feilds', 'id' => 'n-filds', 'readonly'))}}
 		</div>
 		{{Form::text('ParentMname', $parents->m_name, array('placeholder' => 'Middle name', 'class' => 'form-control feilds', 'id' => 'n-filds', 'readonly'))}}
 	<div class = "div-text plname">
 		{{Form::text('ParentLastname', $parents->l_name, array('placeholder' => 'Last name', 'class' => 'form-control feilds', 'id' => 'n-filds', 'readonly'))}}
 		</div>
 ...
 <!-- div for nationality and religion////////////////////////////////////////////////////////////////////////////////////////////////////-->
 	...
 	<div class = "div-text age" style = "width: 13%;">
 		{{Form::text('Age', $parents->age, array('placeholder' => 'Age', 'class' => 'form-control feilds', 'id' => 'n-filds', 'style' => 'width: 100%;', 'readonly'))}}
 		</div>

 		
 	<div class = "div-text hea" style = "width: 84%;">
 		{{Form::text('HEA', $parents->heda, array('placeholder' => 'Highest Education Attainment', 'class' => 'form-control feilds', 'id' => 'n-filds', 'style' => 'width: 100%;', 'readonly'))}}
 		</div>
 ...
 <!-- div for mail address ////////////////////////////////////////////////////////////////////////////////////////////////////-->
	...
	<div class="form-group div-filds" style = "width:100%">
		...
		<div class = "div-text occ" style = "width:100%">
 			{{Form::text('Occupation', $parents->occp, array('placeholder' => 'Occupation', 'class' => 'form-control feilds', 'id' => 'filds', 'style' => 'width:98%;', 'readonly'))}}
 		</div>
 	...
 	<div class = "div-text pnat" style = "width: 47%;">
 		{{Form::text('ParentNationality', $parents->nationality, array('placeholder' => 'Nationality', 'class' => 'form-control feilds', 'id' => 'n-filds', 'style' => 'width: 100%;', 'readonly'))}}
 		</div>
 	<div class = "div-text prel" style = "width: 50%;">
 		{{Form::text('ParentReligion', $parents->religion, array('placeholder' => 'Religion', 'class' => 'form-control feilds', 'id' => 'n-filds', 'style' => 'width: 100%;', 'readonly'))}}
 		</div>
  ...
  <!-- div for mail address ////////////////////////////////////////////////////////////////////////////////////////////////////-->
	...
	<div class="form-group div-filds" style = "width:100%">
		...
		<div class = "div-text mnum" style = "width:100%">
 			{{Form::text('MobileNumber', $parents->cell_no, array('placeholder' => 'Mobile Number', 'class' => 'form-control feilds', 'id' => 'filds', 'style' => 'width:98%;', 'readonly'))}}
 		</div>
		...
		@endif
 		...
 		{{ Form::submit('Back', array('class' => 'btn btn-info', 'id' => 'csubmit', 'style' => 'color:white;')) }}
 	{{Form::close()}}
</div>
</div>
