...
<div class="container crud">
  ...
  <h2 class = "crud-head">Payment Schedule</h2>
 	...
 	{{Form::open(array('route' => 'PaySched.store', 'class' => 'form-inline'))}}
@if($errors->first('schoolyear')) 
  ...
  <strong>Warning!</strong> {{ $errors->first('schoolyear')}}
 	...
 	<div class = "div-text start" style = "width: 100%;">
 		{{Form::text('first', '', array('placeholder' => 'First Payment', 'class' => 'form-control feilds', 'id' => 'datetimepicker', 'style' => 'width: 100%;cursor:pointer;', 'readonly'))}}
...
@if($errors->first('first')) 
	...
	<div class="form-group div-filds" style = "width: 100%;">
		...
		<div class = "div-text end" style = "width: 100%;">
 		{{Form::text('second', '', array('placeholder' => 'Second Payment', 'class' => 'form-control feilds', 'id' => 'datetimepicker1', 'style' => 'width: 100%;cursor: pointer;', 'readonly'))}}
 	...
 	<div class = "div-text three" style = "width: 100%;">
 		{{Form::text('third', '', array('placeholder' => 'Third Payment', 'class' => 'form-control feilds', 'id' => 'datetimepicker3', 'style' => 'width: 100%;cursor:pointer;', 'readonly'))}}
 		<script type="text/javascript">
 	 $(document).ready(function(){
...
@if($errors->first('third')) 
 	...
 	<div class = "div-text four" style = "width: 100%;">
 		{{Form::text('fourth', '', array('placeholder' => 'Fourth Payment', 'class' => 'form-control feilds', 'id' => 'datetimepicker4', 'style' => 'width: 100%;cursor:pointer;', 'readonly'))}}
 		<script type="text/javascript">
 	 $(document).ready(function(){
...
@if($errors->first('fourth')) 
 	...
 	<div class = "div-text five" style = "width: 100%;">
 		{{Form::text('fifth', '', array('placeholder' => 'Fifth Payment', 'class' => 'form-control feilds', 'id' => 'datetimepicker5', 'style' => 'width: 100%;cursor:pointer;', 'readonly'))}}
 		<script type="text/javascript">
 	 $(document).ready(function(){
...
@if($errors->first('fifth')) 
 	...
 	<div class = "div-text six" style = "width: 100%;">
 		{{Form::text('sixth', '', array('placeholder' => 'Sixth Payment', 'class' => 'form-control feilds', 'id' => 'datetimepicker6', 'style' => 'width: 100%;cursor:pointer;', 'readonly'))}}
 		<script type="text/javascript">
 	 $(document).ready(function(){
...
@if($errors->first('sixth')) 
 	...
 	<div class = "div-text seven" style = "width: 100%;">
 		{{Form::text('seventh', '', array('placeholder' => 'Seventh Payment', 'class' => 'form-control feilds', 'id' => 'datetimepicker7', 'style' => 'width: 100%;cursor:pointer;', 'readonly'))}}
 		<script type="text/javascript">
 	 $(document).ready(function(){
...
@if($errors->first('seventh')) 
 	...
 	<div class="form-group div-filds" style = "width: 100%;">
 	<div class = "div-text start" style = "width: 100%;">
 		{{Form::text('eight', '', array('placeholder' => 'Eight Payment', 'class' => 'form-control feilds', 'id' => 'datetimepicker8', 'style' => 'width: 100%;cursor:pointer;', 'readonly'))}}
 		<script type="text/javascript">
 	 $(document).ready(function(){
...
@if($errors->first('eight')) 
 	...
 	<div class = "div-text nine" style = "width: 100%;">
 		{{Form::text('ninth', '', array('placeholder' => 'Ninth Payment', 'class' => 'form-control feilds', 'id' => 'datetimepicker9', 'style' => 'width: 100%;cursor:pointer;', 'readonly'))}}
 		<script type="text/javascript">
 	 $(document).ready(function(){
...
@if($errors->first('ninth')) 
 	...
 	<div class = "div-text ten" style = "width: 100%;">
 		{{Form::text('tenth', '', array('placeholder' => 'Tenth Payment', 'class' => 'form-control feilds', 'id' => 'datetimepicker10', 'style' => 'width: 100%;cursor:pointer;', 'readonly'))}}
 		<script type="text/javascript">
 	 $(document).ready(function(){
