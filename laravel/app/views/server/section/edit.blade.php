...
<div class="container crud">
  ...
  <h2 class = "crud-head">Edit Section</h2>
 	...
 	{{Form::open(array('route' => array('Section.update', $section->sec_id), 'class' => 'form-inline', 'method' => 'PUT'))}}
	...
	<div class="form-group div-filds">
		<div class = "div-text sec">
 			{{Form::text('section', $section->section, array('placeholder' => 'Section', 'class' => 'form-control feilds', 'id' => 'filds'))}}
 		</div>
